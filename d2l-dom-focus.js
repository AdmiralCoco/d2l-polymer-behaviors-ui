...
import { Visibility } from './d2l-dom-visibility.js';
...
export const Focus = {
	...
	getFirstFocusableDescendant: function(node, includeHidden) {
		...
		var composedChildren = Dom.getComposedChildren(node);
	...
	getPreviousFocusable: function(node, includeHidden) {
		...
		var _getPreviousAncestorSibling = function(node) {
			...
			while (parentNode) {
				...
				parentNode = Dom.getComposedParent(parentNode);
			}
